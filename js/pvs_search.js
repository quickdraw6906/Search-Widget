...
function get_search_box_code(){
        ...
        var html = '';
        html += '<div style="width: 100%; text-align: center; margin: 15px auto;"><a style="padding: 5px; text-decoration: none;" href="http://votesmart.org/" onclick="window.open(this.href)"><img src="http://votesmart.org/static/images/subpages/share/capitol_guy_blue_trans_sm.gif" style="border: 0px;" /><br />Project Vote Smart</a></div>';
